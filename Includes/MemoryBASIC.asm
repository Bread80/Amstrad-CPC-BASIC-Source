...
unknown_ON_BREAK_GOSUB_data EQU $ac17
...
channel_and_rendezvous_status EQU $ad99
...
DEF_FN_linked_list_head EQU $adeb
...
trace_flag           EQU $ae1f
tokenise_state_flag  EQU $ae20
line_address_vs_line_number_flag EQU $ae21
DELETE_range_start   EQU $ae22
DELETE_range_length  EQU $ae24
address_to_load_binary_file_to EQU $ae26
CHAIN_MERGE_flag     EQU $ae28
file_type_from_file_header EQU $ae29
file_length_from_file_header EQU $ae2a
program_protection_flag_ EQU $ae2c
preconversion_buffer EQU $ae2d
conversion_buffer    EQU $ae3a
end_of_conversion_buffer EQU $ae3e
exponent_prefix      EQU $ae4c
exponent_value       EQU $ae4e
end_of_number_in_format_buffer EQU $ae4f
trailing_sign_in_format_buffer EQU $ae50
end_of_format_buffer EQU $ae51
Chars_before_the_decimal_point_in_format EQU $ae52
Chars_after_decimal_point_in_format_stri EQU $ae53
Print_format_currency_symbol___or_ EQU $ae54
...
ZONE_value           EQU $ae5c
end_of_PRINT_USING_expr_list_flag EQU $ae5d
HIMEM_               EQU $ae5e
...
file_buffer_flags    EQU $b075
address_of_4k_file_buffer_ EQU $b076
address_of_the_highest_byte_of_free_RAM_ EQU $b078
string_move_offset   EQU $b07a
